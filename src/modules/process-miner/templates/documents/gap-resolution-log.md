...
| QA Agent (Document) | {{qa_doc_raised}} | {{qa_doc_resolved}} | {{qa_doc_open}} | {{qa_doc_deferred}} |
| QA Agent (Suite) | {{qa_suite_raised}} | {{qa_suite_resolved}} | {{qa_suite_open}} | {{qa_suite_deferred}} |

---

## How to Read This Document

> This document tracks all **validation gaps (VG#)** raised during QA validation and TO-BE transformation validation, and their resolution status. It serves as the persistent audit trail for quality assurance — gaps are tracked from detection through resolution across sessions.
>
> **Gap Sources:**
> - **QA Agent (Document):** Per-document validation gaps found by qa-check and qa-validation workflows
> - **QA Agent (Suite):** Cross-document consistency gaps found by qa-suite-validation workflow
> - **Specialist Agents:** Domain-specific gaps raised during TO-BE transformation validation
>
> **Parent Document:** [Target State Documentation](./target-state-documentation.md) (when it exists — this log may be created earlier by QA workflows)
>
> **Gap Severity Levels:**
...
| **Severity** | {{this.severity}} |
| **Status** | {{this.status}} |
| **Source Workflow** | {{this.source_workflow}} |
| **Document** | {{this.document_validated}} |
| **Check Category** | {{this.check_category}} |
...
|----------|---------|------|
| Target State Documentation | Parent document (when exists) | [target-state-documentation.md](./target-state-documentation.md) |
| Transformation Decisions Detail | Decision rationale | [transformation-decisions-detail.md](./transformation-decisions-detail.md) |
| QA Suite Report | Cross-document validation report | [_qa-suite-report.md](./_qa-suite-report.md) |
...
_Generated by ProcessMiner Transformation Agent & QA Agent_
